...
\maketitle
    ...
    Seluruh implementasi dan dataset yang digunakan dalam penelitian ini tersedia secara publik untuk mendukung reprodusibilitas penelitian. \footnote{\url{https://github.com/username/project}}.
